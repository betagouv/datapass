  ...
  <ScrollablePanel scrollableId={SECTION_ID}>
    ...
    <Quote>
      <p>
        ...
        est conditionné entre-autre au respect par le demandeur de ses
        obligations fiscales et sociales et à l’adéquation du service proposé
        avec l’objet de l’API.
      </p>
      <p>
        Si votre demande est validée, vous recevrez par mail une licence à
