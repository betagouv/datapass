...
export const CadreJuridiqueDescription = () => (
  <>
    <p>
      Pour pouvoir bénéficier du raccordement à l’API indemnités pole emploi,
...
export const availableScopes = [
  {
    value: 'beneficiairePrestationSolidarite',
    label: 'Béneficiaire de prestations de solidarité',
    mandatory: true,
  },
  {
    value: 'beneficiaireAssuranceChomage',
    label: 'Bénéficiaire d‘une assurance chômage',
    mandatory: true,
  },
];

const target_api = 'api_indemnites_pole_emploi';

const ApiIndemnitesPoleEmploi = () => (
  <Form
...
export default ApiIndemnitesPoleEmploi;
