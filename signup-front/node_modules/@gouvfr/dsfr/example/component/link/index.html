            ...
            <div class="fr-container">
                <div class="fr-grid-row fr-grid-row--center">
                    <div class="fr-col-md-8 fr-col-12">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-546">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-546">
                                    <pre class=" language-html"><code>&lt;a class="fr-link" href="#"&gt;Label lien&lt;/a&gt;
</code></pre>
                                </div>
                            </section>
                        </div>
                        ...
                        <div class="fr-mb-6v">
                            <a class="fr-link fr-fi-arrow-left-line fr-link--icon-left" href="#">Label lien</a>
                        </div>
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-547">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-547">
                                    <pre class=" language-html"><code>&lt;a class="fr-link fr-fi-arrow-left-line fr-link--icon-left" href="#"&gt;Label lien&lt;/a&gt;
</code></pre>
                                </div>
                            </section>
                        </div>
                        ...
                        <div class="fr-mb-6v">
                            <a class="fr-link fr-fi-arrow-right-line fr-link--icon-right" href="#">Label lien</a>
                        </div>
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-548">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-548">
                                    <pre class=" language-html"><code>&lt;a class="fr-link fr-fi-arrow-right-line fr-link--icon-right" href="#"&gt;Label lien&lt;/a&gt;
</code></pre>
                                </div>
                            </section>
                        </div>
                        <h4>Lien icon seul</h4>
                        <div class="fr-mb-6v">
                            <a class="fr-link fr-fi-arrow-right-line" href="#">Label lien</a>
                        </div>
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-549">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-549">
                                    <pre class=" language-html"><code>&lt;a class="fr-link fr-fi-arrow-right-line" href="#"&gt;Label lien&lt;/a&gt;
</code></pre>
                                </div>
                            </section>
                        </div>
                        <h4>Lien seul SM</h4>
                        <div class="fr-mb-6v">
                            <a class="fr-link fr-link--sm" href="#">Label lien</a>
                        </div>
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-550">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-550">
                                    <pre class=" language-html"><code>&lt;a class="fr-link fr-link--sm" href="#"&gt;Label lien&lt;/a&gt;
</code></pre>
                                </div>
                            </section>
                        </div>
                        <h4>Lien seul LG</h4>
                        <div class="fr-mb-6v">
                            <a class="fr-link fr-link--lg" href="#">Label lien</a>
                        </div>
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-551">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-551">
                                    <pre class=" language-html"><code>&lt;a class="fr-link fr-link--lg" href="#"&gt;Label lien&lt;/a&gt;
</code></pre>
                                </div>
                            </section>
                        </div>
                        <h4>Lien seul button</h4>
                        <div class="fr-mb-6v">
                            <button class="fr-link">Label lien</button>
                        </div>
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-552">Extrait de code</button>
                                </h3>
                                <div class="fr-collapse" id="snippet-552">
                                    <pre class=" language-html"><code>&lt;button class="fr-link"&gt;Label lien&lt;/button&gt;
</code></pre>
                                </div>
                            </section>
                        </div>
                        <h4>Lien seul button désactivé</h4>
                        <div class="fr-mb-6v">
                            <button class="fr-link" disabled>Label lien</button>
                        </div>
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                ...
                                <div class="fr-collapse" id="snippet-553">
                                    <pre class=" language-html"><code>&lt;button class="fr-link" disabled&gt;Label lien&lt;/button&gt;
</code></pre>
                                </div>
                            </section>
                        </div>
...
<div class="fr-link" >Label lien</div>
...
<section class="fr-accordion">
  ...
  <div class="fr-collapse" id="snippet-554">
      ...
      <pre class=" language-html"><code>&lt;div class="fr-link"&gt;Label lien&lt;/div&gt;
</code></pre>
 ...
 -->
        ...
        <button class="fr-display-button fr-background-default--white fr-btn fr-btn--lg fr-fi-theme-fill fr-btn--secondary" aria-controls="fr-theme-modal" data-fr-opened="false">
            Label bouton
        </button>
