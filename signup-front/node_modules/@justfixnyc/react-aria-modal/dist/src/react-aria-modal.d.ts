...
export interface AriaModalProps {
    ...
    underlayProps?: HTMLDivProps & any;
    focusTrapOptions?: Partial<FocusTrapOptions>;
    focusTrapPaused?: boolean;
}
declare type HTMLDivProps = React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>;
declare type ReactAriaModal = React.ComponentType<AriaModalProps> & {
    renderTo: (input: string | Element) => React.ComponentType<AriaModalProps>;
};
declare const AriaModal: ReactAriaModal;
