class EnrollmentSerializer < ActiveModel::Serializer
  attributes :updated_at, :created_at, :id, :target_api, :previous_enrollment_id, :copied_from_enrollment_id,
    ...
    :data_recipients, :data_retention_period, :data_retention_comment, :demarche, :technical_team_type, :technical_team_value,
    :type_projet, :date_mise_en_production, :volumetrie_approximative, :dpo_is_informed, :notify_events_from_demandeurs_count, :zip_code
