...
RSpec.describe EnrollmentsArchiveable, type: :service do
  ...
  describe "#enrollments_to_archive" do
    ...
    before do
      ...
      create(:event, :update, enrollment: enrollment, created_at: 40.days.ago, updated_at: 40.days.ago)
      create(:event, :reminder, enrollment: enrollment, created_at: 20.days.ago, updated_at: 20.days.ago)
    ...
    context "#enrollments_to_archive" do
      it "renders an array of enrollments with draft and change_requested status" do
