...
export const scopesConfiguration = [
  {
    ...
    label: 'Scolarisé',
    helper: 'Indique si l’élève est scolarisé (réponse oui/non)',
  },
  {
    value: 'men_statut_boursier',
    label: 'Boursier',
    helper: 'Indique si l’élève est boursier (réponse oui/non)',
  },
  {
...
const target_api = 'api_scolarite';
