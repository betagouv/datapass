...
const target_api = 'api_rial_production';
const steps = ['api_rial_sandbox', target_api];

const ApiRialProduction = () => (
  <Form
  ...
  >
    ...
    <CguSection cguLink="/docs/cgu_prod_api_rial_v2024-11.pdf" />
  </Form>
);

export default ApiRialProduction;
