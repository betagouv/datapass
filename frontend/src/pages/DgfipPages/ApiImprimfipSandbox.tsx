...
const target_api = 'api_imprimfip_sandbox';
const steps = [target_api, 'api_imprimfip_production'];

const ApiImprimfipSandbox = () => (
  <Form
  ...
  >
    ...
    <ÉquipeSection />
    <CguSection
      cguLink="/docs/cgu_bas_imprimfip_v.2023_09.pdf"
      additionalTermsOfUse={additionalTermsOfUse}
    />
  </Form>
);

export default ApiImprimfipSandbox;
