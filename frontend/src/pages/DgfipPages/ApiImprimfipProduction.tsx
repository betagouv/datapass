...
const target_api = 'api_imprimfip_production';
const steps = ['api_imprimfip_sandbox', target_api];

const ApiImprimfipProduction = () => (
  <Form
  ...
  >
    ...
    <VolumetrieSection />
    <CguSection cguLink="/docs/cgu_prod_imprimfip_v.2023_09.pdf" />
  </Form>
);

export default ApiImprimfipProduction;
