...
const questions = [
  ...
  },
  {
    ...
    body: (
      <>
        Si vous souhaitez modifier les coordonnées de votre compte (par exemple
        si cela vous a été demandé dans le cadre d'une demande d'habilitation),{' '}
        <Link
          newTab
          inline
        ...
        <br />
        <br />A noter : Vous ne pouvez pas modifier l'adresse mail associée au
        compte. Si vous souhaitez utiliser une autre adresse mail, merci de{' '}
        <Link inline href="https://auth-staging.api.gouv.fr/users/sign-in">
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <Link inline href="https://auth.api.gouv.fr/users/join-organization">
          le faire ici.
        </Link>
        <br />
        <br />
  ...
  },
  {
    ...
    body: (
      <>
        Sur quelques formulaires d'habilitation, la question "Qui va implémenter
        l’API" vous est posée. Cette question permet au fournisseur de l'API de
        vous accompagner au mieux dans son utilisation. 3 options sont possibles
        :
        <br />
        <br />- Développeurs en interne : les personnes qui vont implémenter
        l'API travaillent dans la même organisation que vous (ou c’est
        vous-même).
        <br />- Editeur de logiciel : vous utilisez un logiciel, et c'est via
        cet outil que vous allez exploiter les données.
        <br />- Autre : si les deux options ci-dessus ne vous conviennent pas,
        vous pouvez indiquer le nom ou le SIRET de l'organisation qui
